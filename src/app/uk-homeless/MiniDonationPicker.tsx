...
export default function MiniDonationPicker() {
  ...
  return (
    <div className="max-w-lg mx-auto">
      ...
      {isAmountValid ? (
        <Link href={`/donate?campaign=uk-homeless&amount=${amountForUrl}&frequency=${frequency}`} className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-amber text-charcoal hover:bg-amber-dark font-semibold shadow-sm text-base transition-colors duration-200 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">
