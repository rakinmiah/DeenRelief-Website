  ...
  return (
    <div>
      ...
      <p className="text-grey text-base sm:text-[1.0625rem] leading-[1.7] mb-1">
        Your donation builds permanent water infrastructure. Gift Aid adds 25%.
      </p>
      ...
      <div className="mb-4">
        ...
        {customAmountError && (
          <p id="custom-amount-error" className="text-[12px] text-red-600 font-medium mt-1.5 ml-1" role="alert">
            {customAmountError}
          </p>
        )}
      </div>
      ...
      {isAmountValid ? (
        <Button
          variant="primary"
          size="lg"
          href={`/donate?campaign=clean-water&amount=${amountForUrl}&frequency=${frequency}`}
