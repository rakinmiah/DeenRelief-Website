...
import { getUpsellChips } from "./upsell";
...
export default function DonationForm() {
  ...
  // "Make your gift go further" nudges — adds a researched increment to the
  // current amount. If the new total lands on a preset we let that preset
  // highlight; otherwise we surface it in the custom field so the donor can
  // see and edit the figure they just chose.
  const upsellChips = getUpsellChips(amountForUrl);
  ...
  return (
    <div className="text-center">
      ...
      {isAmountValid && upsellChips.length > 0 && (
