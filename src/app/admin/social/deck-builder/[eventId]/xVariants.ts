...
export const X_VARIANTS: TemplateMeta[] = [
  ...
  },
  {
    id: "x-impact",
    name: "Impact words",
    description: "Three staccato impact words over the photo (the OCHA 'Casualties. Damage.' pattern) + a stat ribbon.",
    platforms: ["x"],
    category: "hero",
    aspect: "wide",
    size: { w: 1200, h: 675 },
  ...
  {
    id: "x-appeal-tiers",
    name: "Emergency appeal + tiers",
    description: "Emotional photo + a red appeal chip + the £-tier ladder ('£X provides Y') + Donate + Zakat trust line. The conversion workhorse.",
    platforms: ["x"],
    category: "cta",
    aspect: "wide",
    size: { w: 1200, h: 675 },
